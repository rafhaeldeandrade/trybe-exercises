...
/* Usando a tabela rental , extraia data, ano, mês, dia, hora, minuto
e segundo dos registros com rental_id = 10330. Utilize a coluna
rental_date para extrair as informações */
SELECT 
    DAY(rental_date) AS 'Dia',
    MONTH(rental_date) AS 'Mês',
    YEAR(rental_date) AS 'Ano',
    HOUR(rental_date) AS 'Dia',
...
/* Monte uma query que retorne todos os dados do pagamento
