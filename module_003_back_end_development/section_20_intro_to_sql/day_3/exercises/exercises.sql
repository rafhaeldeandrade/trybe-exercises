...
-- 2. Escreva uma query para exibir todos os fornecimentos que contenham a peça com
--code 2 . Organize o resultado por ordem alfabética de fornecedor.
...
-- 5. Escreva uma query para exibir o número de empresas (fornecedores) que contém a
-- letra F no código.
