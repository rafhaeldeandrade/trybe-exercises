/* Monte uma query que exiba o id do ator , nome do ator e id do filme em que ele
...
nome em ordem decrescente, juntamente com o id do endereço e o endereço onde o cliente
mora. Essas informações podem ser encontradas nas tabelas customer e address */
SELECT 
    c.customer_id,
...
/* Exiba o nome e a quantidade de endereços dos clientes cadastrados. Ordene seus
resultados por nomes de forma decrescente. Exiba somente os clientes ativos. As
informações podem ser encontradas na tabela address e customer. */
SELECT 
...
usando as tabelas actor , film_actor e film. Dica: você precisará fazer mais de
