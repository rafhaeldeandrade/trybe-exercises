...
if (salarioBase <= 2826.65 && salarioBase > 1903.98) {
  console.log(salarioBase - (salarioBase * 0.075 - 142.8));
} else if (salarioBase <= 3751.05) {
  console.log(salarioBase - (salarioBase * 0.15 - 354.8));
} else if (salarioBase <= 4664.68) {
  console.log(salarioBase - (salarioBase * 0.225 - 636.13));
} else if (salarioBase > 4664.68) {
  console.log(salarioBase - (salarioBase * 0.275 - 869.36));
} else {
